(() => {
  ...
  const boot = () => {
    ...
    const state = window.BIBLE_FIGHTER_STABILITY = window.BIBLE_FIGHTER_STABILITY || { version:'1.1', bounds:[34,884], separation:44, hitstop:0 };
    ...
    window.BIBLE_FIGHTER_CLEAR_INPUT = clearInput;
