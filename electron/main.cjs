  ...
  win.webContents.once('did-finish-load', () => {
    ...
    setTimeout(async () => {
      try {
        ...
        const afterAttack = await win.webContents.executeJavaScript(`window.BIBLE_FIGHTER_MULTIPLAYER.snapshot()`, true);
        console.log(`[smoke] multiplayer-final ${JSON.stringify(afterAttack)}`);
