...
const boot=()=>{syncVersionUi();mount('data/update-manifest.js','bibleManifest');mount('data/combat-core.js','combatData');mount('game43.js','davidPolish');mount('game44.js','cooldown');mount('game45.js','realCombat');mount('game46.js','combatCore');mount('game47.js','verticalSlice');mount('game48.js','runtimePolish');mount('game49.js','combatDiagnostics');};
