...
console.log('Build validation passed: combat runtime + HUD + identity + codex + briefing + enforced frame + David art + impact + local 2P + 2D Elah/Red-Sea stages present.');
