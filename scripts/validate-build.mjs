...
const required = ['playtest.html','style.css','game7.js','game8.js','game9.js','game10.js','game11.js','game12.js','game13.js','game14.js','game15.js','game19.js','game20.js','game21.js','game22.js','game23.js','game8.css','game20.css','game21.css','game22.css','game23.css','data/characters.js','data/supports.js','data/missions.js','data/codex.js','electron/main.cjs','Playtest-Windows.bat'];
...
for (const file of ['game7.js','game8.js','game9.js','game10.js','game11.js','game12.js','game13.js','game14.js','game15.js','game19.js','game20.js','game21.js','game22.js','game23.js','electron/main.cjs']) {
  const result = spawnSync(process.execPath,['--check',file],{stdio:'inherit'});
  if (result.status !== 0) process.exit(result.status ?? 1);
}
console.log('Build validation passed: combat runtime + HUD + identity + codex + briefing layers present.');
