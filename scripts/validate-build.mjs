...
for (const marker of ['BIBLE_FIGHTER_DAVID_ART_READY','Valley of Elah','davidStone']) if (!readFileSync('game26.js','utf8').includes(marker)) { console.error(`Build validation failed: game26.js missing David art marker: ${marker}`); process.exit(1); }

for (const file of ['game7.js','game8.js','game9.js','game10.js','game11.js','game12.js','game13.js','game14.js','game15.js','game19.js','game20.js','game21.js','game22.js','game23.js','game24.js','game25.js','game26.js','electron/main.cjs']) {
  const result = spawnSync(process.execPath,['--check',file],{stdio:'inherit'});
  if (result.status !== 0) process.exit(result.status ?? 1);
}
console.log('Build validation passed: combat runtime + HUD + identity + codex + briefing + frame rules + David art present.');
