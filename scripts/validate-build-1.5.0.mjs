...
const pkg=JSON.parse(readFileSync('package.json','utf8'));if(pkg.version!=='1.5.1')fail(`package version: ${pkg.version}`);for(const f of ['game46.js','game47.js','game48.js','playtest.html','electron/**/*','data/**/*'])if(!pkg.build.files.includes(f))fail(`package omit: ${f}`);
