...
const expectedRuntime = ['data/characters.js','data/supports.js','data/missions.js','data/codex.js','game7.js','game19.js','game20.js','game21.js','game22.js','game23.js'];
...
if (!(scripts.indexOf('game20.js') > scripts.indexOf('game19.js')) || !(scripts.indexOf('game21.js') > scripts.indexOf('game20.js')) || !(scripts.indexOf('game22.js') > scripts.indexOf('game21.js')) || !(scripts.indexOf('game23.js') > scripts.indexOf('game22.js'))) fail('combat layers must load in order');
...
for (const required of ['playtest.html','game20.js','game21.js','game22.js','game23.js','game20.css','game21.css','game22.css','game23.css','data/**/*','electron/**/*']) if (!buildFiles.includes(required)) fail(`electron-builder package files omit ${required}`);
...
console.log(`Runtime validation passed: ${scripts.length} scripts + ${styles.length} stylesheets, combat HUD/identity/codex/briefing entry intact.`);
